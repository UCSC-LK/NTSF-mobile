...
public class V_fine extends Activity implements OnClickListener {

    EditText Nic,VehicleNo,Location,FineNo,Description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PoliceId = storenew.getPoliceId(V_fine.this);

        System.out.println("Police id: "+PoliceId);

        super.onCreate(savedInstanceState);
        setContentView(R.layout.v_fine);
        ...
        home.setOnClickListener(view -> {
            Intent intent=new Intent(V_fine.this, Home.class);
            startActivity(intent);
        });

        Button viewButton = findViewById(R.id.viewbtn);
        viewButton.setOnClickListener(view -> {
            Intent intent=new Intent(V_fine.this, V_list.class);
            startActivity(intent);
        });
    }
...
//        String Nic_String = Nic.getText().toString();
    ...
    private void showNextpage() {
        Intent intent;
        intent = new Intent(V_fine.this, Message.class);
